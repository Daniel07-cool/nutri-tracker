...
export default function App() {
  ...
  async function checkBackendConnection() {
    try {
      ...
      console.error(error);
      setLoadingMessage("No se pudo conectar con la base de datos.");
    } finally {
      setTimeout(() => {
    ...
    return (
      <div className="loading-screen">
        <div className="loading-card">
          ...
          <h2>Cargando tu plan nutricional</h2>
          <p>{loadingMessage}</p>
    ...
    <div className="page">
      <header className="topbar">
        <div className="brand-block">
          <h1 className="brand-title">Tu Plan Nutricional</h1>
          <p className="brand-subtitle">
            Registrá tus comidas diarias y llevá el control de tu alimentación.
          </p>
        </div>
      ...
      <nav className="main-nav">
        {["Inicio", "Productos", "Registros"].map((item) => (
          <button
            key={item}
            type="button"
          ...
          <section className="home-hero">
            <div className="home-hero-content">
              ...
              <p className="home-description">
                Organizá tus comidas, controlá tus registros diarios y consultá
                tus productos de forma simple, clara y visual.
              </p>

              <div className="home-actions">
                <button
                  type="button"
                  className="meal-shortcut breakfast"
                ...
                <button
                  type="button"
                  className="meal-shortcut dinner"
                  onClick={() => setActiveSection("Registros")}
                >
                  🥣 Cena
                </button>
                <button
                  type="button"
                  className="meal-shortcut snacks"
                  onClick={() => setActiveSection("Registros")}
                >
                  🍎 Snacks
                </button>
        ...
        <>
          ...
          <section className="card">
            <div className="toolbar">
              <div>
                <h2>Productos</h2>
                <p>Filtra por clasificación nutricional.</p>
              </div>
